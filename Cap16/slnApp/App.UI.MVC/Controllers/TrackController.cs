...
namespace App.UI.MVC.Controllers
{
    ...
    public class TrackController : Controller
    {
        ...
        {
            var url = "http://s000-00:8093/ReportServer/Pages/ReportViewer.aspx?%2fChinookReportes%2frptInvoice&rs:Format=PDF&InvoiceId=" + id.ToString();
            //var url = "http://s000-00:8093/ReportServer/Pages/ReportViewer.aspx?%2fChinookReportes%2frptInvoice&rs:Format=EXCELOPENXML&InvoiceID=" + id.ToString();

            //var nwc = new NetWorkCredential
            var wc = new WebClient();
            //wc.Credentials = nwc;
            wc.Credentials = System.Net.CredentialCache.DefaultCredentials;

            // return File(wc.DownloadData(url), "aplication/vnd.ms-excel");
            return File(wc.DownloadData(url), "aplication/pdf");
